...
// BookingCreatedHostMailView renders a notification email for the host when a new booking arrives.
func BookingCreatedHostMailView(hostName, bookingID, propertyTitle, checkIn, checkOut string, totalNight, guestCount int, totalPrice float64) string {
	return fmt.Sprintf(`
		<!DOCTYPE html>
		<html>
						...
						<table width="600" style="background:#ffffff; padding:40px; border-radius:16px; border:1px solid #e5e5e5;">
							...
							<tr>
								<td style="padding-top:16px; font-size:16px; color:#444; line-height:1.6;">
									Halo <b>%s</b>, properti Anda baru saja mendapatkan booking. Silakan konfirmasi ketersediaan melalui dashboard.
								</td>
							</tr>
							...
							<tr>
								<td style="padding-top:24px; font-size:15px; color:#444; line-height:1.6;">
									Segera masuk ke dashboard untuk mengonfirmasi atau menolak booking ini.
								</td>
							</tr>
